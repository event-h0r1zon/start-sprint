...
const SportsSelection: React.FC<SportsSelectionProps> = ({
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center p-6 animate-fade-in">
      <h1 className="text-3xl font-bold text-white mb-2">BOXLY</h1>
      <p className="text-gray-400 text-center mb-8">Start your training session and get real-time feedback</p>
      
      <div className="w-full max-w-2xl mb-12">
        <Carousel className="w-full">
          <CarouselContent className={`justify-center`}>
            {sports.map((sport) => (
              <CarouselItem key={sport.id} className="md:basis lg:basis-1/4">
                <div 
                  className={`
